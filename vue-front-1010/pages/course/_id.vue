        ...
        <aside class="c-attr-wrap">
          ...
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg">
              ...
              <b class="c-yellow pricePosition" style="font-size:24px;">￥{{courseWebVo.price}}</b>
            ...
            <section class="c-attr-mt" v-if="isbuy||Number(courseWebVo.price)===0">
              <a href="#c-i-tabTitle" title="立即观看" class="comm-btn c-btn-3">立即观看</a>
            </section>
